...
#include "ctre.h"  //BIT Defines + Typedefs, TALON_Control_6_MotProfAddTrajPoint_t
#include "CtreCanNode.h"
#include "structs_mtrCntrl.h"
...
class CanTalonSRX : public CtreCanNode,
 ...
 private:
   ...
   *         when needed to save bandwidth.
   */
  CtreCanNode::txTask<TALON_Control_7_FeedbackOutputOverride_t> GetControl7();
 ...
 */
  ...
  CTR_Code SetDataPortOutputPeriodMs(int param);
  CTR_Code SetDataPortOutputEnable(int idx, int param);
  CTR_Code SetDataPortOutputOnTimeMs(int idx, int param);
};
extern "C" {
