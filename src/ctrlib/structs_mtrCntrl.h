...
typedef struct _TALON_Control_7_FeedbackOutputOverride_t {
	unsigned OnTime3Ms:8;
	unsigned OnTime4Ms:8;
	unsigned OnTime5Ms:8;
	unsigned OnTime6Ms:8;
	unsigned OnTime7Ms:8;
	unsigned OnTime8Ms:8;
	unsigned PeriodMs:8;
	unsigned reserved0:2;
	unsigned OutputEnable_Ch3:1;
	unsigned OutputEnable_Ch4:1;
	unsigned OutputEnable_Ch5:1;
	unsigned OutputEnable_Ch6:1;
	unsigned OutputEnable_Ch7:1;
	unsigned OutputEnable_Ch8:1;
} TALON_Control_7_FeedbackOutputOverride_t;
